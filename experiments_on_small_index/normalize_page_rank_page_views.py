...
#     merged_results.update(add_scores_to_merged_dict(0.27,titles_docs_result_dict))
#     merged_results.update(add_scores_to_merged_dict(0.17, bodies_docs_result_dict))
#     merged_results.update(add_scores_to_merged_dict(0.56, anchors_docs_result_dict))
#
...
#     with open("top_k_results_from_all_indexes.json","r") as f:
...
#         with open("model_best_results_for_each_query.json","w") as x:
...
# # print(sorted([log(view,10) for view in page_views_dict.values()], reverse=True)[:10])
# # print(sorted([log(view,10) for view in page_views_dict.values() if view!=1])[:10])
...
# #
# # print(sorted([log(float(num)+1) for num in page_rank_doc_id_rank_dict.values()])[100000:100010])
# # print(sorted([log(float(num)+1) for num in page_rank_doc_id_rank_dict.values()],reverse=True)[10000:10010])
#
