...
index = InvertedIndex.read_index(f"postings_small_anchor_text_gcp","index")
AVGDL = index.AVGDL
...
for term in query_terms:
    if term in index.df.keys():
        inverted_index_dict[term] = index.read_posting_list(term,f"postings_small_anchor_text_gcp")
